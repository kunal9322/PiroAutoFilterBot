...
○  ɪᴛs'𝗌 ɴᴏᴛ ᴄᴏᴍᴘʟɪᴄᴀᴛᴇᴅ.🤓

○  sᴇᴀʀᴄʜ ᴜsɪɴɢ ɪɴʟɪɴᴇ ᴍᴏᴅᴇ

ᴛʜɪs ᴍᴇᴛʜᴏᴅ ᴡᴏʀᴋs ᴏɴ ᴀɴʏ ᴄʜᴀᴛ, ᴊᴜsᴛ ᴛʏᴘᴇ ʙᴏᴛ ᴜsᴇʀɴᴀᴍᴇ ᴀɴᴅ ᴛʜᴇɴ ʟᴇᴀᴠᴇ ᴀ sᴘᴀᴄᴇ ᴀɴᴅ sᴇᴀʀᴄʜ ʏᴏᴜʀ ǫᴜᴇʀʏ ʏᴏᴜ ᴡᴀɴᴛ... 🥳

🙋🏻‍♂️ ᴛᴜᴛᴏʀɪᴀʟ ɢᴜɪᴅᴇ @MH17_KUNAL
○ ᴀ𝗏ᴀɪʟᴀʙʟᴇ ᴄᴏᴍᴍᴀɴᴅs   

 /alive - ᴄʜᴇᴄᴋ ɪ'ᴍ ᴀʟɪᴠᴇ..
 /status - ʙᴏᴛ sᴛᴀᴛᴜs
 /info - ᴜsᴇʀ ɪɴғᴏ
 /ping - ᴛᴏ ɢᴇᴛ ʏᴏᴜʀ ᴘɪɴɢ
 /id - ᴜsᴇʀ ɪᴅ
 /stats - ᴅʙ sᴛᴀᴛᴜs  
 /broadcast - ʙʀᴏᴀᴅᴄᴀsᴛ (ᴏᴡɴᴇ𝗋 𝖮𝗇𝗅𝗒)
